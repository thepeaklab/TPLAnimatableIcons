#
#  Be sure to run `pod spec lint TPLAnimatableIcons.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/thepeaklab/TPLAnimatableIcons.git", :tag => s.version.to_s}
